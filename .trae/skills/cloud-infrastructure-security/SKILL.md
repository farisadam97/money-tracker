...
description: "Cloud & infrastructure security: IAM, secrets, network, CI/CD. Invoke when deploying to cloud, configuring IAM, setting up pipelines, or managing cloud secrets."
---
...
resource "aws_db_instance" "good" {
  ...
  vpc_security_group_ids = [aws_security_group_db.id]
}
```
